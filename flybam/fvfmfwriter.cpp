...
void FVFmfWriter::WriteTraj(Point2f world, Point2f head, Point2f galvo_angle, int odor)
{
	fprintf(ftraj, "%d %f %f %f %f %f %f %d\n", nframes, world.x, world.y, head.x, head.y, galvo_angle.x, galvo_angle.y, odor);
}
