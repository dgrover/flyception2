...
void FVFmfWriter::WriteTraj(Point2f world, Point2f head, Point2f galvo_angle, int z_track, int lens_pos, double var_lap)
{
	fprintf(ftraj, "%d %f %f %f %f %f %f %d %d %f\n", nframes, world.x, world.y, head.x, head.y, galvo_angle.x, galvo_angle.y, z_track, lens_pos, var_lap);
}
